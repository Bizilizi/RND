    ...
    def criterion(self, forward_output: ForwardOutput, targets) -> CriterionOutput:
        ...
        if image_emb is not None:
            ...
            distances = (
                ...
                + torch.sum(self.class_representatives**2, dim=1)
                - 2 * torch.matmul(image_emb, self.class_representatives.t())
            )
            ...
            if self.training:
                ...
                for class_idx in classes_in_batch:
                    ...
                    self.class_representatives[class_idx] = (
                        self.class_representatives[class_idx] * self.decay
