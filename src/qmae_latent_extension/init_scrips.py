...
from src.qmae_latent_extension.metrics.vq_vae_confusion_matrix import (
    vq_vae_confusion_matrix_metrics,
)
from src.qmae_latent_extension.metrics.vq_vae_forgetting import (
    vq_vae_forgetting_metrics,
)
from src.qmae_latent_extension.metrics.vq_vae_loss import vq_vae_loss_metrics
...
def get_callbacks(
    ...
    return lambda experience_step: [
        ...
        VisualizeProjections(benchmark, log_every=2, num_images=100),
