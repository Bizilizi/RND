...
class Trainer(object):
    ...
    def generator_trainstep(self, y, z, Iterr=0, is_lowrank=False):
        ...
        if is_lowrank and Iterr % 10 == 0:
            lr_loss = self.lowrank_constr(
                z.device, lamda_gama=self.CONS_lowrank, lamda_beta=self.CONS_lowrank
            )
    ...
    def discriminator_trainstep(self, x_real, y, x_fake0, Iterr=0):
        ...
        if self.reg_type == "wgangp":
            ...
            reg = self.reg_param * self.wgan_gp_reg(x_real, x_fake0, y, center=0.0)
            reg.backward()
