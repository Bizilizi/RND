...
from src.joined_qmae_igpt.train_image_gpt import (
    BootstrappedDataset,
    get_image_embedding,
    sample_images,
    bootstrap_past_samples,
)
from src.joined_qmae_igpt.utils.fid_score import calculate_fid_given_datasets
...
def calculate_fid_score_for_all_cl_steps(
    ...
    ini_config.read("./src/joined_qmae_igpt/configuration/train.ini")
