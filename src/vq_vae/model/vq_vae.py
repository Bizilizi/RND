...
from src.vq_vae.model.decoder import Decoder, GPTDecoder
from src.vq_vae.model.encoder import Encoder, VitEncoder
...
class VitVQVae(CLModel):
    ...
    def forward(self, x):
        ...
        return vq_loss, x_recon, quantized, x, perplexity, image_emb, logits
    ...
    def training_step(self, batch, batch_idx):
        ...
        (
            ...
            contrastive_loss,
            perplexity,
        ) = self.criterion(forward_output, y)

        loss = vq_loss + reconstruction_loss + contrastive_loss
