...
from src.encode_decode_encode.callbacks.codebook_histogram import LogCodebookHistogram
from src.encode_decode_encode.callbacks.projections_visualisations import (
    VisualizeProjections,
)
from src.rnd.callbacks.log_model import LogModelWightsCallback
from src.encode_decode_encode.callbacks.log_dataset import LogDataset
from src.encode_decode_encode.callbacks.training_reconstions_vis import (
    VisualizeTrainingReconstructions,
)
from src.encode_decode_encode.configuration.config import TrainConfig
from src.encode_decode_encode.metrics.vq_vae_confusion_matrix import (
    vq_vae_confusion_matrix_metrics,
)
from src.encode_decode_encode.metrics.vq_vae_forgetting import (
    vq_vae_forgetting_metrics,
)
from src.encode_decode_encode.metrics.vq_vae_loss import vq_vae_loss_metrics
from src.encode_decode_encode.model.vit_vq_vae import VitVQVae
...
def get_model(config: TrainConfig, device: torch.device) -> VitVQVae:
    vae = VitVQVae(
        ...
        latent_consistency_loss_weight=config.cycle_consistency_loss_weight,
