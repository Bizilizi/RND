...
from src.encode_decode_encode.init_scrips import (
    get_benchmark,
    get_model,
    get_cl_strategy,
)
from src.encode_decode_encode.model.image_gpt import ImageGPTForCausalImageModeling
from src.encode_decode_encode.train_image_gpt import (
    BootstrappedDataset,
    get_image_embedding,
    sample_images,
    bootstrap_past_samples,
)
from src.encode_decode_encode.utils.fid_score import calculate_fid_given_datasets
from src.encode_decode_encode.utils.wrap_empty_indices import (
    wrap_dataset,
)
...
def calculate_fid_score_for_all_cl_steps(
    ...
    ini_config.read("./src/encode_decode_encode/configuration/train.ini")
