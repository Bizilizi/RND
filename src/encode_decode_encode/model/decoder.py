...
from src.encode_decode_encode.model.encoder import take_indexes
from src.encode_decode_encode.model.image_gpt import ImageGPTConfig, ImageGPTModel
from src.encode_decode_encode.model.vit import VisionTransformer
